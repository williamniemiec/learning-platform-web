    	...
    	<div class="view_content">
        	<form method="POST">
        		...
        		<div class="form-group">
            		...
            		<input id="name" type="text" name="name" placeholder="Name" class="form-control" value="<?php echo $user->get_name(); ?>" />
            	</div>
            	...
            	<div class="form-group">
            		...
            		<input id="birthdate" type="date" name="birthdate" class="form-control" value="<?php echo $user->get_birthdate()->format("Y-m-d"); ?>" />
            	</div>
