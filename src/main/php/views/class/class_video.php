<div class="class_content">
    ...
    <iframe 
        id="class_video" 
        frameborder="0" 
        src="https://www.youtube.com/embed/<?php echo $class->getVideoID(); ?>"
    >
    </iframe>
                ...
                <li class="notebook-item">
                    ...
                    <div class="notebook-item-footer">
                        ...
                        <div class="notebook-item-date">
                            <?php echo $note->getCreationDate()->format("m/d/Y H:i:s"); ?>
                        </div>
                    </div>
                </li>
            <?php endforeach; ?>
                ...
                <div class="comment">
                    <img	
                        ...
                        src="<?php echo empty($comment['comment']->getCreator()) || empty($comment['comment']->getCreator()->getPhoto()) 
                            ...
                            : BASE_URL."src/main/webapp/images/profile_photos/".$comment['comment']->getCreator()->getPhoto(); ?>" 
                    />
                    <div class="comment_content">
                        <div class="comment_info">
                            <!-- Comment info -->
                            <h5>
                                <?php echo empty($comment['comment']->getCreator()) 
                                    ? "Deleted user" 
                                    : $comment['comment']->getCreator()->getName(); ?>
                            </h5>
                            <p>
                                <?php echo $comment['comment']->getContent(); ?>
                            </p>
                            <button 
                                class="btn btn-small" 
                                onclick="open_reply(this)"
                            >
                                &ldca; Reply
                            </button>
                                    ...
                                    <div class="comment comment_reply_content">
                                        <img
                                            ...
                                            src="<?php echo empty($reply->getCreator()) || empty($reply->getCreator()->getPhoto())  
                                                ? BASE_URL."src/main/webapp/images/default/noImage.png"  
                                                : BASE_URL."src/main/webapp/images/profile_photos/".$reply->getCreator()->getPhoto(); ?>"
                                        />
                                        <div class="comment_content">
                                            <div class="comment_info">
                                                <h5>
                                                    <?php echo empty($reply->getCreator()) 
                                                        ? "Deleted user" 
