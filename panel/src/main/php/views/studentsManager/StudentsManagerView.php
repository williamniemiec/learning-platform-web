                    ...
                    <div class="search-filter-options">
                            <div class="form-group">
                                <select 
                                    ...
                                    class="form-control"
                                >
                                    <option value="0" <?php echo $selectedCourse == 0 ? "selected" : "" ?>>
                                        All
                                    </option>
                                    <?php foreach ($courses as $course): ?>
                                        <option 
                                            value="<?php echo $course->getId(); ?>" 
                                            <?php echo $selectedCourse == $course->getId() ? "selected" : ""; ?>
                                        >
                ...
                <tbody>
                    <?php foreach ($students as $student): ?>
                        <tr data-id_student="<?php echo $student->getId(); ?>">
                            ...
                            <td class="student_totalBundles">
                                <?php echo count($student->getBundles()); ?>
                            </td>
                            <td class="actions">
                                <button 
                                    class="btn_theme" 
                                    onclick="show_editStudent(<?php echo $student->getId(); ?>)"
                                >
                                    Edit
                                </button>
                                <button 
                                    class="btn_theme btn_theme_danger" 
                                    onclick="deleteStudent(this,<?php echo $student->getId(); ?>)"
                                >
                                    Delete
                                </button>
                            </td>
