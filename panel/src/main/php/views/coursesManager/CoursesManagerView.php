    ...
    <div class="view_panel">
        ...
        <div class="view_content">
            ...
            <?php else: ?>
                ...
                <a class="btn_theme" href="<?php BASE_URL; ?>courses/new">
                    New
                </a>
                    ...
                    <tbody id="courses">
                        <?php foreach($courses as $course): ?>
                            <tr>
                                ...
                                <?php endif; ?>
                                <td>
                                    <a href="<?php echo BASE_URL."courses/edit/".$course->getId(); ?>">
                                ...
                                <td class="actions">
                                    <a 
                                        class="btn_theme" 
                                        href="<?php echo BASE_URL."courses/edit/".$course->getId(); ?>"
                                    >
                                        Edit
                                    </a>
                                    <a 
                                        class="btn_theme btn_theme_danger" 
                                        href="<?php echo BASE_URL."courses/delete/".$course->getId(); ?>"
                                    >
                                        Delete
                                    </a>
                                </td>
                ...
                <ul class="pagination pagination-sm justify-content-center">
                    <li class="page-item <?php echo ($currentIndex - 1 <= 0) ? "disabled" : ""; ?>">
                        <a 
                            href="<?php echo BASE_URL."courses?index=".($currentIndex - 1); ?>" 
                            class="page-link"
                        >
                        Before
                    </a>
                    ...
                    <?php for ($i=1; $i<=$totalPages; $i++): ?>
                        ...
                        >
                            <a 
                                href="<?php echo BASE_URL."courses?index=".$i; ?>" 
                                class="page-link"
                            >
                                <?php echo $i; ?>
                            </a>
