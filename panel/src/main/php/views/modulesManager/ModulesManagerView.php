<div class="container">
    <div class="view_panel">
        ...
        <div class="view_content">
            ...
            <?php else: ?>
                <a class="btn_theme" href="<?php BASE_URL; ?>modules/new">
                    New
                </a>
                <table class="table table-hover table-stripped text_centered">
                    ...
                    <tbody>
                        <?php foreach($modules as $module): ?>
                            <tr>
                                <td>
                                    <a href="<?php echo BASE_URL."modules/edit/".$module->getId(); ?>">
                                ...
                                <td class="actions">
                                    <a 
                                        class="btn_theme" 
                                        href="<?php echo BASE_URL."modules/edit/".$module->getId(); ?>"
                                    >
                                        Edit
                                    </a>
                                    <a 
                                        class="btn_theme btn_theme_danger" 
                                        href="<?php echo BASE_URL."modules/delete/".$module->getId(); ?>"
                                    >
                                        Delete
                                    </a>
                                </td>
                ...
                <ul class="pagination pagination-sm justify-content-center">
                    <li class="page-item <?php echo ($currentIndex - 1 <= 0) ? "disabled" : ""; ?>">
                        <a 
                            href="<?php echo BASE_URL."modules?index=".($currentIndex - 1); ?>" 
                            class="page-link"
                        >
                            Before
                        </a>
                    ...
                    <?php for ($i=1; $i<=$totalPages; $i++): ?>
                        ...
                        >
                            <a 
                                href="<?php echo BASE_URL."modules?index=".$i; ?>" 
                                class="page-link"
                            >
                                <?php echo $i; ?>
                            </a>
