...
class Action
{
     ...
     * or equal to zero
     */
    public function updateCourse(int $id_course) : void
    {
        if (empty($id_course) || $id_course <= 0)
            throw new \InvalidArgumentException("Course id cannot be null or".
                "less than or equal to zero");
     ...
     * or equal to zero
     */
    public function updateBundle(int $id_bundle) : void
    {
        if (empty($id_bundle) || $id_bundle <= 0)
            throw new \InvalidArgumentException("Bundle id cannot be null or".
                "less than or equal to zero");
     ...
     * or equal to zero
     */
    public function updateModule(int $id_module) : void
    {
        if (empty($id_module) || $id_module <= 0)
            throw new \InvalidArgumentException("Module id cannot be null or".
                "less than or equal to zero");
     ...
     * null or less than or equal to zero
     */
    public function updateClass(int $id_module, int $class_order) : void
    {
        if (empty($id_module) || $id_module <= 0)
            throw new \InvalidArgumentException("Module id cannot be null or".
                "less than or equal to zero");
        ...
        $this->action = $this->update("Class - id_module=".$id_module.", class_order=".$class_order);
    }
     ...
     * or equal to zero
     */
    public function updateAdmin(int $id_admin) : void
    {
        if (empty($id_admin) || $id_admin <= 0)
            throw new \InvalidArgumentException("Admin id cannot be null or".
                "less than or equal to zero");
            
        $this->action = $this->update("Admin - id_admin=".$id_admin);
    }
     ...
     * or equal to zero
     */
    public function updateStudent(int $id_student) : void
    {
        if (empty($id_student) || $id_student <= 0)
            throw new \InvalidArgumentException("Student id cannot be null or".
                "less than or equal to zero");
            
        $this->action = $this->update("Student - id_student=".$id_student);
    }
    ...
    public function answerTopic(int $id_topic) : void
    {
        ...
        $this->action = $this->update("Topic answered - id_topic=".$id_topic);
    }
